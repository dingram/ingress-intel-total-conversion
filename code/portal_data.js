...
window.portalApGainMaths = function(resCount, linkCount, fieldCount) {
  ...
  var deployAp = (8-resCount)*iitc.constants.DEPLOY_RESONATOR;
  if (resCount == 0) deployAp += iitc.constants.CAPTURE_PORTAL;
  if (resCount != 8) deployAp += iitc.constants.COMPLETION_BONUS;
  ...
  var destroyResoAp = resCount*iitc.constants.DESTROY_RESONATOR;
  var destroyLinkAp = linkCount*iitc.constants.DESTROY_LINK;
  var destroyFieldAp = fieldCount*iitc.constants.DESTROY_FIELD;
